    ...
    document.addEventListener("click", (event) => {
        if (event.target.classList.contains("link-item")) {
            ...
            if (event.target.hash !== "") {
                ...
                // if clicked 'link-item' is from nav menu
...
(() => {
    ...
    tabsConatiner.addEventListener('click', (event) => {
        ...
        if (event.target.classList.contains('tab-item') &&
            ...
            tabsConatiner.querySelector('.active').classList.remove('active', 'outer-shadow');
            // activate new tab item
            event.target.classList.add('active', 'outer-shadow');
            // deactivate existsing tab-content
...
// SECTION - Portfolio Filter and Popup
(() => {
    ...
    filterConatainer.addEventListener("click", (event) => {
        if (event.target.classList.contains("filter-item") &&
            !event.target.classList.contains("active")) {
            filterConatainer.querySelector(".active").classList.remove("outer-shadow", "active");
            event.target.classList.add("active", "outer-shadow");
            const target = event.target.getAttribute("data-target");
    ...
    function popupSlideshow() {
        ...
        // activate the loader intil popupImg is active
...
// SECTION - Hide all except active
